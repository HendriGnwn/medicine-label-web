...
@section('headerTitle', 'Laporan Obat Per Periode')
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div aria-required="true" class="form-group required form-group-default">
                            ...
                            {!! Form::text('date_period', null, ['class' => 'form-control date-range form-sm']) !!}
                        </div>
                    </div>
                    <div class="col-md-4">
...
function exportToExcel() {
    window.open('{{ route("report.period.export-to-excel") }}?' + $("#filter-search-form").serialize(), '_blank');
    return false;
}

$("#filter-search-form").submit(function() {
    window.open('{{ route("report.period.list") }}?' + $("#filter-search-form").serialize(), '_blank');
    return false;
});
